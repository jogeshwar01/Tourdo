...
exports.getCheckoutSession = catchAsync(async (req, res, next) => {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        client_reference_id: req.params.tourId, //allows us to pass data about the session we are creating--helpful later  --helpful now in createBookingCheckout fn
...
// to make the process of payment super super secure
